...
package com.vuforia.samples.ImageTargets;
...
//        mTextures.add(Texture.loadTextureFromApk("abc.png",
//                getAssets()));
//        mTextures.add(Texture.loadTextureFromApk("abc.png",
//                getAssets()));
...
//            .add(Texture.loadTextureFromApk("Buildings.jpeg", getAssets()));
    ...
    private void setSampleAppMenuSettings()
    {
        ...
        group.addRadioItem("Test", CMD_DATASET_TEST_DATASET, true);
        group.addRadioItem("Stones & Chips",
            CMD_DATASET_STONES_AND_CHIPS_DATASET, false);
    ...
    public boolean menuProcess(int command) {
        ...
        switch (command) {
            ...
            case CMD_DATASET_TEST_DATASET:
                switchDatasetAsap(TEST_DATASET_ID);
                break;
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            synchronized (mShutdownLock) {
                Vuforia.setInitParameters(ImageTargets.this, mVuforiaFlags, "");
