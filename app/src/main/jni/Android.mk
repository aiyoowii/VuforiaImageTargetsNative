...
LOCAL_SRC_FILES = ../../../../../../vuforia-sdk-android-6-2-10/build/lib/$(TARGET_ARCH_ABI)/libVuforia.so
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/../../../../../../vuforia-sdk-android-6-2-10/build/include
...
LOCAL_SRC_FILES := ImageTargets.cpp SampleAppRenderer.cpp SampleUtils.cpp Texture.cpp
